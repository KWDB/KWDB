...
namespace kwdbts {
template <class T>
bool GorillaIntV2<T>::Compress(TSSlice data, uint64_t count, TsBufferBuilder *out,
...
template class GorillaIntV2<int32_t>;
template class GorillaIntV2<int64_t>;
...
bool GorillaInt::Compress(TSSlice data, uint64_t count, TsBufferBuilder *out, const TsCompressionConfig &cfg) const {
