...
static_assert(std::has_unique_object_representations_v<TsEntitySegmentBlockItem> == true,
              "seems that TsEntitySegmentBlockItem has padding");
...
static_assert(std::has_unique_object_representations_v<TsEntityItemFileHeader> == true);
...
static_assert(std::has_unique_object_representations_v<TsEntityItem> == true);
