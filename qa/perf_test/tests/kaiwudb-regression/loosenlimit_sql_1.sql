SELECT cdp.index_upper_value as upper_value,
...
WHERE o.companyid = csd.company_id      -- 1/1, 1/2
  ...
  AND o.tag in ('MAT83104', '1003')
  AND o.time BETWEEN '2023-01-01' AND '2024-01-01 02:00:00'
GROUP BY timebucket, upper_value
ORDER BY upper_value, timebucket ASC; 