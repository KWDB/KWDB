-- Query 13: primary tag as join key with concat to an empty string with ts primary tag column 
-- fallback case, similar reason as query 12, therorectically, this can be simplified, and 
-- concat can be removed as redundant during compilation
...
where pi.point_sn = concat(t.point_sn, '')
