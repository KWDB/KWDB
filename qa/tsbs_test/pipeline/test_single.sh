...
TSBS_SCALE="${2:-"4000,100000,1000000"}"
TSBS_FORMAT="${3:-"kwdb"}"
QUERY_WORKERS="${4:-"1"}"
QUERY_TIMES="${5:-"10"}"
ENABLE_PERF="${6:-"false"}"
INSERT_TYPE="${7:-"prepare"}"
CLUSTER_NODE_NUM="${8:-"1"}"
WAL="${9:-"2"}"
REPLICA_MODE="${10:-"1"}"
LOAD_WORKERS="${11:-"12"}"
INSERT_DIRECT="${12:-"1"}"
