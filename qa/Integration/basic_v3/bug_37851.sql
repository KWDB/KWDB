...
CREATE TABLE db_pipec.t_point(k_timestamp TIMESTAMP NOT NULL,measure_value DOUBLE) ATTRIBUTES (point_sn VARCHAR(64) NOT NULL,sub_com_sn VARCHAR(32),work_area_sn VARCHAR(16), station_sn VARCHAR(16),pipeline_sn VARCHAR(16),measure_type SMALLINT, measure_location varchar(64)) PRIMARY TAGS (point_sn);
use db_pipec;
