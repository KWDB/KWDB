...
function appendDataFrame(input_df, con::Connection, table::AbstractString, schema::String = "public")
...
appendDataFrame(input_df, db::DB, table::AbstractString, schema::String = "public") =
...
"""
function load!(con, input_df, table::AbstractString, schema::String = "public")
    register_data_frame(con, input_df, "__append_df")
