...
#ifndef DUCKDB_EXTENSION_MYSQL_LINKED
#define DUCKDB_EXTENSION_MYSQL_LINKED false
#endif
...
#if DUCKDB_EXTENSION_MYSQL_LINKED
...
static const DefaultExtension internal_extensions[] = {
    ...
    {"mysql_scanner", "Adds support for connecting to a MySQL database", DUCKDB_EXTENSION_MYSQL_LINKED},
...
ExtensionLoadResult ExtensionHelper::LoadExtensionInternal(DuckDB &db, const std::string &extension,
	...
	if (extension == "parquet") {
		...
		return ExtensionLoadResult::NOT_LOADED;
#endif
	} else if (extension == "mysql_scanner") {
#if DUCKDB_EXTENSION_MYSQL_LINKED
		db.LoadStaticExtension<MysqlScannerExtension>();
#else
		return ExtensionLoadResult::NOT_LOADED;
#endif
	}
