...
static const DefaultMacro internal_macros[] = {
	...
	{DEFAULT_SCHEMA, "current_catalog", {nullptr}, {{nullptr, nullptr}}, "public.current_database()"},          // name of current database (called "catalog" in the SQL standard)
	...
	{"pg_catalog", "current_database", {nullptr}, {{nullptr, nullptr}}, "system.public.current_database()"},  	    // name of current database (called "catalog" in the SQL standard)
	{"pg_catalog", "current_query", {nullptr}, {{nullptr, nullptr}}, "system.public.current_query()"},  	        // the currently executing query (NULL if not inside a plpgsql function)
	{"pg_catalog", "current_schema", {nullptr}, {{nullptr, nullptr}}, "system.public.current_schema()"},  	        // name of current schema
	{"pg_catalog", "current_schemas", {"include_implicit"}, {{nullptr, nullptr}}, "system.public.current_schemas(include_implicit)"},  	// names of schemas in search path
