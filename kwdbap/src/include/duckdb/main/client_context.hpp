...
public:
	...
	DUCKDB_API unique_ptr<QueryResult> KWQuery(const string &query, shared_ptr<PreparedStatementData> &prepared, bool allow_stream_result);
  ...
  bool AttachDB(std::string name, std::string path);
private:
    ...
    unique_ptr<PendingQueryResult> KWPendingStatementOrPreparedStatement(ClientContextLock &lock, const string &query,
                                                                         shared_ptr<PreparedStatementData> &prepared,
                                                                         const PendingQueryParameters &parameters);
    ...
    shared_ptr<PreparedStatementData>
    ConvertFlowToPhysicalPlan(ClientContextLock &lock, const string &query, const string &database, const string &table,
                              string flowSpecs, PreparedStatementMode mode = PreparedStatementMode::PREPARE_ONLY);

	unique_ptr<PendingQueryResult> PendingStatementInternal(ClientContextLock &lock, const string &query,
	                                                        unique_ptr<SQLStatement> statement,
	                                                        const PendingQueryParameters &parameters);

    unique_ptr<PendingQueryResult> KWPendingStatementInternal(ClientContextLock &lock, const string &query,
