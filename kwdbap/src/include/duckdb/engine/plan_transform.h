...
class TransFormPlan {
 public:
  ...
  PhyPlanPtr TransFormPhysicalPlan(const kwdbts::ProcessorSpec& procSpec, const kwdbts::PostProcessSpec& post,
      const kwdbts::ProcessorCoreUnion& core, std::vector<PhyPlanPtr> &child);
