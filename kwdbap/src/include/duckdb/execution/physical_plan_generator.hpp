...
public:
    ...
    unique_ptr<PhysicalPlan> KWPlan(vector<string> flowSpecs, TableCatalogEntry &table, StatementProperties &properties, vector<string> &res_names);

    void InitPhysicalPlan();

    unique_ptr<PhysicalPlan> GetPhysicalPlan();
