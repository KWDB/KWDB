...
- repository-local skills index: `.agents/skills/README.md`
  - Current available skills:
    - `kwdb-ci-failure-triage/`: CI failure triage guidelines for KWDB repository
    - `kwdb-document-writing/`: Functional specification and design document writing for KWDB database features
    - `kwdb-unit-test-guidelines/`: Go and cpp unit test writing and guidelines for KWDB repository
    - `kwdb-refactor/`: Code refactoring for KWDB (Go/C++) — planning, complexity reduction, code smell elimination, with behavior-preserving verification
    - `kwdb-code-review/`: KWDB-specific code review skills
