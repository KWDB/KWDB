...
func (sr *streamRecalculator) updateAllSplitWindowEndTimestamp() error {
	...
	if sqlconst.SplitWindowUpdateMaxRequest < uncompletedCount {
		uncompletedCount = sqlconst.SplitWindowUpdateMaxRequest
	}
...
func (sr *streamRecalculator) HandleHistoryRows() error {
	...
	historicalWaterMark, ok, err = sr.loadLowWaterMark(sqlconst.WaterMarkTypeHistorical)
	if err != nil {
		return err
	}
	...
	if ok {
		...
		realtimeWaterMark, _, err = sr.loadLowWaterMark(sqlconst.WaterMarkTypeRealtime)
		if err != nil {
			return err
		}
...
VALUES ($1,$2,$3,$4,$5)`,
		...
		sqlconst.WaterMarkTypeHistorical,
		watermark,
	); err != nil {
		return err
	}
...
func (sr *streamRecalculator) loadLowWaterMark(typ sqlconst.WaterMarkType) (int64, bool, error) {
