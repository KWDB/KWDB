...
// -------- internal helpers for Constraint --------
...
func (c *Constraint) allColsAreNonNull(indexCols, notNullCols opt.ColSet, evalCtx *tree.EvalContext) bool {
...
func (c *Constraint) computeDistinctValCount(evalCtx *tree.EvalContext, numCols, prefix int) uint64 {
	switch {
...
// modified.
func (c *Constraint) combineSpansWithSuffix(keyCtx KeyContext, other *Constraint, offset int) (Spans, bool) {
	var result Spans
...
func (c *Constraint) emitExactValueSpans(result *Spans, keyCtx *KeyContext, other *Constraint, sp *Span) {
...
func convertSpanToTimestamp(start Key, startBoundary bool, end Key, endBoundary bool, prec int64) (int64, int64) {
