...
func TestShowHistogramColumns(t *testing.T) {
	...
	require.Equal(t, 4, len(ddl.ShowHistogramColumns))
	require.Equal(t, "upper_bound", ddl.ShowHistogramColumns[0].Name)
	require.Equal(t, types.String, ddl.ShowHistogramColumns[0].Typ)
	require.Equal(t, "range_rows", ddl.ShowHistogramColumns[1].Name)
	require.Equal(t, types.Int, ddl.ShowHistogramColumns[1].Typ)
	require.Equal(t, "distinct_range_rows", ddl.ShowHistogramColumns[2].Name)
	require.Equal(t, types.Float, ddl.ShowHistogramColumns[2].Typ)
	require.Equal(t, "equal_rows", ddl.ShowHistogramColumns[3].Name)
	require.Equal(t, types.Int, ddl.ShowHistogramColumns[3].Typ)
}
...
func TestShowHistogramColumnsTypes(t *testing.T) {
	...
	require.Equal(t, types.String.Family(), ddl.ShowHistogramColumns[0].Typ.Family())
	require.Equal(t, types.Int.Family(), ddl.ShowHistogramColumns[1].Typ.Family())
	require.Equal(t, types.Float.Family(), ddl.ShowHistogramColumns[2].Typ.Family())
	require.Equal(t, types.Int.Family(), ddl.ShowHistogramColumns[3].Typ.Family())
}
