...
func TestCreateDatabaseNodeMethods(t *testing.T) {
	...
	node := ddl.NewCreateDatabaseNode(
		&tree.CreateDatabase{
			Name: "test_db",
		},
	)
...
func TestCreateFunctionNodeMethods(t *testing.T) {
	...
	node := ddl.NewCreateFunctionNode(
		&tree.CreateFunction{
...
func TestCreateScheduleNodeMethods(t *testing.T) {
	...
	node := ddl.NewCreateScheduleNode(
		&tree.CreateSchedule{
