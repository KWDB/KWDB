...
import (
	...
	"gitee.com/kwbasedb/kwbase/pkg/sql/ddl"
...
func TestShowTriggersColumns(t *testing.T) {
	...
	// Verify ddl.ShowTriggersColumns
	require.Equal(t, 6, len(ddl.ShowTriggersColumns))
	require.Equal(t, "trigger_name", ddl.ShowTriggersColumns[0].Name)
	require.Equal(t, types.String, ddl.ShowTriggersColumns[0].Typ)
	require.Equal(t, "trigger_action_time", ddl.ShowTriggersColumns[1].Name)
	require.Equal(t, types.String, ddl.ShowTriggersColumns[1].Typ)
	require.Equal(t, "trigger_event", ddl.ShowTriggersColumns[2].Name)
	require.Equal(t, types.String, ddl.ShowTriggersColumns[2].Typ)
	require.Equal(t, "trigger_order", ddl.ShowTriggersColumns[3].Name)
	require.Equal(t, types.Int, ddl.ShowTriggersColumns[3].Typ)
	require.Equal(t, "on_table", ddl.ShowTriggersColumns[4].Name)
	require.Equal(t, types.String, ddl.ShowTriggersColumns[4].Typ)
	require.Equal(t, "enabled", ddl.ShowTriggersColumns[5].Name)
	require.Equal(t, types.Bool, ddl.ShowTriggersColumns[5].Typ)
}
...
func TestShowTriggersColumnsTypes(t *testing.T) {
	...
	require.Equal(t, types.String.Family(), ddl.ShowTriggersColumns[0].Typ.Family())
	require.Equal(t, types.String.Family(), ddl.ShowTriggersColumns[1].Typ.Family())
	require.Equal(t, types.String.Family(), ddl.ShowTriggersColumns[2].Typ.Family())
	require.Equal(t, types.Int.Family(), ddl.ShowTriggersColumns[3].Typ.Family())
	require.Equal(t, types.String.Family(), ddl.ShowTriggersColumns[4].Typ.Family())
	require.Equal(t, types.Bool.Family(), ddl.ShowTriggersColumns[5].Typ.Family())
}
