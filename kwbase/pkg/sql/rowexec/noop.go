...
func (n *noopProcessor) handleMetaForTs(meta *execinfrapb.ProducerMetadata) (NeedMoreMetas bool) {
	...
	case execinfrapb.OperatorType_TsDropTsTable, execinfrapb.OperatorType_TsDropDeleteEntities,
		execinfrapb.OperatorType_TsVacuum, execinfrapb.OperatorType_TsAutonomy:
	...
	case execinfrapb.OperatorType_APDropDatabase:
		if n.InputNum > 1 {
			if meta != nil {
	...
	case execinfrapb.OperatorType_APDropTable:
		if n.InputNum > 1 {
			if meta != nil {
