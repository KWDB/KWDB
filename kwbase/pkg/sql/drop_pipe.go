...
func (p *planner) DropPipe(ctx context.Context, n *tree.DropPipe) (planNode, error) {
	...
	if err = p.checkPipePrivilege(ctx, nil, privilege.DROP, pipe); err != nil {
		return nil, err
	}

	return &dropPipeNode{pipeID: pipe.id, pipeName: n.PipeName, meta: pipe}, nil
}
...
func (p *planner) canRemoveAllTableOwnedPipes(
...
func (p *planner) checkTableHasRelPipes(ctx context.Context, tableID uint64) error {
...
func (p *planner) removePipe(ctx context.Context, jobID int64, meta *PipeMetadata) error {
...
func (n *dropPipeNode) startExec(params runParams) error {
	...
	params.p.SetAuditTarget(uint32(n.pipeID), n.pipeName.String(), nil)
	...
	err := params.p.removePipe(params.ctx, n.meta.jobID, n.meta)
	if err != nil {
		return err
	}
