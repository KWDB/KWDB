...
ENUM_MEM(RWLATCH_ID_MMAP_BLOCK_META_RWLOCK),         \
ENUM_MEM(RWLATCH_ID_MMAP_GROUP_PARTITION_RWLOCK),         \
ENUM_MEM(RWLATCH_ID_COMPRESSOR_RWLOCK),         \
ENUM_MEM(RWLATCH_ID_BLOCK_FILE_RWLOCK),         \
...
ENUM_MEM(RWLATCH_ID_TABLE_SCHEMA_RWLOCK),             \
...
ENUM_MEM(RWLATCH_ID_ENTITY_ITEM_RWLOCK),              \
ENUM_MEM(RWLATCH_ID_LAST_SEGMENT_MANAGER_RWLOCK),     \
ENUM_MEM(RWLATCH_ID_VGROUP_PARTITIONS_RWLOCK),        \
ENUM_MEM(RWLATCH_ID_VGROUP_PARTITION_MGR_RWLOCK),     \
ENUM_MEM(RWLATCH_ID_BLOCK_AGG_RWLOCK),                \
ENUM_MEM(RWLATCH_ID_SCHEMA_MGRS_RWLOCK),              \
ENUM_MEM(RWLATCH_ID_VERSION_CONV_RWLOCK),             \
ENUM_MEM(RWLATCH_ID_BATCH_DATA_JOB_RWLOCK),             \
